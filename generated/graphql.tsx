...
export type AssetCreateInput = {
  ...
  thumbnailArticle?: InputMaybe<ArticleCreateManyInlineInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
...
export type AssetManyWhereInput = {
  ...
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  thumbnailArticle_every?: InputMaybe<ArticleWhereInput>;
  thumbnailArticle_none?: InputMaybe<ArticleWhereInput>;
  thumbnailArticle_some?: InputMaybe<ArticleWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type AssetUpdateInput = {
  ...
  mimeType?: InputMaybe<Scalars['String']>;
  size?: InputMaybe<Scalars['Float']>;
  thumbnailArticle?: InputMaybe<ArticleUpdateManyInlineInput>;
  width?: InputMaybe<Scalars['Float']>;
};
...
export type CategoryCreateInput = {
  cl7nt2x8b2rin01t746f2bwam?: InputMaybe<ArticleCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  name: Scalars['String'];
  slug: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
...
export type CategoryUpdateInput = {
  cl7nt2x8b2rin01t746f2bwam?: InputMaybe<ArticleUpdateManyInlineInput>;
  name?: InputMaybe<Scalars['String']>;
  slug?: InputMaybe<Scalars['String']>;
};
...
export type ScheduledOperationAffectedDocument = Article | Asset | Category;
 ...
 *
 * To run a query within a React component, call `useGetArticlesByCategorySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetArticlesByCategorySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetArticlesByCategorySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetArticlesByCategorySlugQuery, GetArticlesByCategorySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetArticlesByCategorySlugQuery, GetArticlesByCategorySlugQueryVariables>(GetArticlesByCategorySlugDocument, options);
      }
export function useGetArticlesByCategorySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetArticlesByCategorySlugQuery, GetArticlesByCategorySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetArticlesByCategorySlugQuery, GetArticlesByCategorySlugQueryVariables>(GetArticlesByCategorySlugDocument, options);
        }
